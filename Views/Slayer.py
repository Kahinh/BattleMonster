...
class SlayerView(lib.discord.ui.View):
    ...
    async def update_view(self, interaction=None):
        if self.tab == "Arme/Armure":
            ...
            embed = lib.Embed.create_embed_profil_attack(self.cSlayer, self.avatar, "l")
        elif self.tab == "H":
            embed = lib.Embed.create_embed_profil_attack(self.cSlayer, self.avatar, "h")
        elif self.tab == "S":
            embed = lib.Embed.create_embed_profil_attack(self.cSlayer, self.avatar, "s")
        else: #Profil
